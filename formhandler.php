...
//$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: --information hidden--' . "\r\n";
// sends bcc to alternate address

//Creates intelligible subject line that shows where it came from
$subject = 'Possible Client for Left-Aligned'; // if your client has more than one web site, you can put the site name here.
...
mail ('marco@left-aligned.com', $subject, $body, $from);
